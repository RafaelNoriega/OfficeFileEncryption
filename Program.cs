...
namespace encryptFile
{
    class PasswordProtectExcel
    {
        ...
        {
            //optionally you can pass in command line arguements
            //debug_mode will take a 1 or 0 to turn on additional logging
            //int i_debug_mode = Int32.Parse(args[0]);
            //string s_sourcefile = args[1];
            //string s_password = args[2];

            int i_debug_mode = 0;
            //file path for excel sheet that will be modified
            string s_sourcefile = @"FILE\PATH\HERE";
            //Enter the password that will be used for the file
